...
async function ensureResources() {
    ...
    if (!fs.existsSync(modelsDir)) {
        ...
        fs.writeFileSync(path.join(modelsDir, 'README.txt'), 'This folder should contain the gemma3-270m model files.\n');
    ...
    if (!fs.existsSync(pythonRuntimeDir)) {
        ...
        fs.writeFileSync(path.join(pythonRuntimeDir, 'README.txt'), 'This folder should contain the portable Python runtime for your platform.\n');
